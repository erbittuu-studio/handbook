...
Pre-made decisions for recurring technology choices, so each new project
starts from a default instead of a debate.
...
Each guide gives **Use / Avoid / Pros / Cons / Alternatives**. When a project
deviates from a default, that's fine — write a one-page ADR in the project
saying why.
